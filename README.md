...
- [telegrammessenger/proxy](https://hub.docker.com/r/telegrammessenger/proxy/) — официальный MTProto прокси
- [telemt](https://github.com/nicehash/telemt) — Rust MTProto прокси
